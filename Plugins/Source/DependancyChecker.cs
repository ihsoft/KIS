...
namespace KIS
{
    ...
    {
        string currentModName = "KIS";
        string assemblyName = "KAS";
        int minimalVersionMajor = 0;
        int minimalVersionMinor = 5;
        int minimalVersionBuild = 2;
        bool checkPresence = false;

        //For old KAS version without any DependancyChecker. Remove this after a KSP update (this way KAS will be surely updated) ?
        public void Start()
        {
